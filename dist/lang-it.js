export default {
  ...
  subtabRender: {
    ...
    box_height: "Altezza box, % della colonna (opzionale)",
    list_title: "Elenco info",
    enable_list: "Mostra come elenco info",
    list_add_row: "Aggiungi riga",
    list_row_name: "Nome",
    alarm_entity: "Entità allarme — fa pulsare il bordo (opzionale)",
    sensor_title: "Configurazione sensore principale",
    entity_choice: "Selettore entità",
    entity2_choice: "Selettore entità secondaria",
    entity2_label: "Etichetta entità secondaria (opzionale)",
    enable_graph: "Abilita grafico",
	graph_range: "Durata del grafico (h)", 
	enable_graphMinMax: "Mostra min / max",
    ...
    header_label: "Etichetta intestazione (opzionale)",
    entity_footer: "Seleziona entità piè di pagina",
    footer_label: "Etichetta piè di pagina (opzionale)",
    entity2_footer: "Seleziona 2ª entità piè di pagina",
    footer2_label: "2ª etichetta piè di pagina (opzionale)",
    entity3_footer: "Seleziona 3ª entità piè di pagina",
    footer3_label: "3ª etichetta piè di pagina (opzionale)",
