export default {
  ...
  subtabRender: {
    ...
    box_height: "Boxhoogte, % van de kolom (optioneel)",
    list_title: "Infolijst",
    ...
    entity2_label: "Label secundaire entiteit (optioneel)",
    ...
    header_label: "Koptekst-label (optioneel)",
    entity_footer: "Selecteer voettekst-entiteit",
    footer_label: "Voettekst-label (optioneel)",
    entity2_footer: "Selecteer 2e voettekst-entiteit",
    footer2_label: "2e voettekst-label (optioneel)",
    entity3_footer: "Selecteer 3e voettekst-entiteit",
    footer3_label: "3e voettekst-label (optioneel)",
